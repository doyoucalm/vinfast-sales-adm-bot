...
export async function handleHelp(ctx: AuthContext): Promise<void> {
  ...
  const lines = [
    ...
    "",
    "*Stats & Status*",
    "• /stats — Ringkasan counter semua kategori",
    "• /status — Ringkasan dokumen pending",
    "• /status <nama|VIN> — Detail semua dokumen",
    "• /ompang [nama|VIN] — Balik nama (kosongkan utk list pending)",
    "• /faktur [nama|VIN] — Faktur",
    "• /stnk [nama|VIN] — STNK & BPKB",
    "",
    "*Stok & DO*",
    "• /do — Unit ready di dealer kamu",
    "• /do <tipe> — Filter by tipe (mis: /do VF5)",
    "",
